    ...
    <div id="wrapper" class="wrapper">
                    ...
                    <div class="header-bottominner">
                        ...
                        <nav class="tm-navigation">
                            <ul>
                                ...
                                <li class="tm-navigation-dropdown"><a href="resources.php">Resources</a> <ul>
                                    <li><a href="/patient_appointment">Patient appointment </a> </li>
                                    <li><a href="eliawards.php">
        ...
        <div class="heroslider-area">
            ...
            <div class="heroslider-slider-2 heroslider-animated-content tm-slider-arrow tm-slider-dots-left">
                ...
                <div class="heroslider-singleslider d-flex align-items-center" data-white-overlay="5" data-bgimage="assets/images/slider/zorza.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7 col-md-8">
                                <div class="heroslider-content">
                                    <h1>Strengthen health system that is universal</h1>

                                    <p>Strengthen health system that is universal, portable, and accessible!</p>
                                    <a href="" class="tm-button">Learn More<b></b></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="heroslider-singleslider d-flex align-items-center" data-white-overlay="5" data-bgimage="assets/images/slider/scope.png">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8 col-md-10">
                                <div class="heroslider-content text-center">
                                    <h1>All patients should be treated fairly, equally, with dignity and respect</h1>

                                    <a href="about.php" class="tm-button">About Us<b></b></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="heroslider-singleslider d-flex align-items-center" data-white-overlay="5" data-bgimage="assets/images/slider/bed.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7 col-md-8">
                                <div class="heroslider-content">
